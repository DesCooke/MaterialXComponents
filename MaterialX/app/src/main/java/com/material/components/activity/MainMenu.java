...
public class MainMenu extends AppCompatActivity {
    ...
    private List<Item> generateMenuItems() {
        ...
        Item lst = new Item(900, "Lists", R.drawable.ic_view_stream, true, MnType.HEAD);
        items.add(lst);
        ...
        items.add(new Item(908, lst.Text, "News Light", true, MnType.SUB, ListNewsLight.class));
        items.add(new Item(909, lst.Text, "News Light Horizontal", true, MnType.SUB, ListNewsLightHorizontal.class));
        items.add(new Item(910, lst.Text, "News Card", true, MnType.SUB, ListNewsCard.class));
        items.add(new Item(911, lst.Text, "News Image", true, MnType.SUB, ListNewsImage.class));
        ...
        items.add(new Item(1819, pfl.Text, "Wallet", true, MnType.SUB, ProfileWallet.class));
        items.add(new Item(1820, pfl.Text, "Tab", true, MnType.SUB, ProfileTab.class));
        items.add(new Item(1821, pfl.Text, "Pink", true, MnType.SUB, ProfilePink.class));
        items.add(new Item(1822, pfl.Text, "White", true, MnType.SUB, ProfileWhite.class));
        items.add(new Item(1823, pfl.Text, "Dark", true, MnType.SUB, ProfileDark.class));
        ...
        Item sp = new Item(23000, "Search Page", R.drawable.ic_search, true, MnType.HEAD);
        items.add(sp);
        ...
        items.add(new Item(23011, sp.Text, "Event Type", true, MnType.SUB, SearchEventType.class));
        items.add(new Item(23012, sp.Text, "Suggestion", true, MnType.SUB, SearchSuggestion.class));
        items.add(new Item(23013, sp.Text, "Suggestion Red", true, MnType.SUB, SearchSuggestionRed.class));
        items.add(new Item(23014, sp.Text, "Outlet", true, MnType.SUB, SearchOutlet.class));
        items.add(new Item(23015, sp.Text, "Outlet Yellow", true, MnType.SUB, SearchOutletYellow.class));
        ...
        items.add(new Item(29009, dsh.Text, "Dana", true, MnType.SUB, DashboardDana.class));
        items.add(new Item(29010, dsh.Text, "Travel", true, MnType.SUB, DashboardTravel.class));
        items.add(new Item(29011, dsh.Text, "News", true, MnType.SUB, DashboardNews.class));
        ...
        Item cht = new Item(32000, "Chat", R.drawable.ic_chat, true, MnType.HEAD);
        items.add(cht);
        items.add(new Item(32001, cht.Text, "Telegram", true, MnType.SUB, ChatTelegram.class));
        items.add(new Item(32002, cht.Text, "WhatsApp", true, MnType.SUB, ChatWhatsapp.class));
        items.add(new Item(32003, cht.Text, "Facebook", true, MnType.SUB, ChatFacebook.class));
        items.add(new Item(32004, cht.Text, "BBM", true, MnType.SUB, ChatBBM.class));
    ...
    private void prepareBanner() {
        ...
        if (NetworkCheck.isConnect(getApplicationContext())) {
            ...
            mAdView.loadAd(new AdRequest.Builder()
                    .addNetworkExtrasBundle(AdMobAdapter.class, bundleExtra).build());
        } else {
